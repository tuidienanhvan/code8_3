...
const Message = ({ love, prevLove }) => {
  ...
  const getMessage = () => {
    ...
    if (love <= 0.2) return "Rất vui vì cậu đã nhắn tin với tớ...";
    if (love <= 0.3) return "Càng nói chuyện tớ càng muốn hiểu cậu hơn...";
    if (love <= 0.4) return "Tớ bất ngờ trước vẻ đẹp của cậu...";
